{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-536294ee-fb25-485f-aecd-ecde094ef620" = [ ];
      ...
      "kmix"."decrease_volume" = ["Volume Down" "Alt+-"];
      "kmix"."increase_microphone_volume" = "Microphone Volume Up";
      "kmix"."increase_volume" = ["Volume Up" "Alt+="];
      "kmix"."mic_mute" = ["Microphone Mute" "Meta+Volume Mute"];
      "kmix"."mute" = ["Volume Mute" "Alt+0"];
      ...
      "kwin"."Switch One Desktop to the Left" = ["Ctrl+Alt+Left" "Meta+Ctrl+Left"];
      "kwin"."Switch One Desktop to the Right" = ["Meta+Ctrl+Right" "Ctrl+Alt+Right"];
      ...
      "mediacontrol"."nextmedia" = ["Media Next" "Alt+9"];
      "mediacontrol"."pausemedia" = "Media Pause";
      "mediacontrol"."playmedia" = [ ];
      "mediacontrol"."playpausemedia" = ["Media Play" "Alt+8"];
      "mediacontrol"."previousmedia" = ["Media Previous" "Alt+7"];
      "mediacontrol"."stopmedia" = ["Media Stop" "Alt+6"];
      "org.kde.dolphin.desktop"."_launch" = "Meta+E";
      "org.kde.konsole.desktop"."NewTab" = [ ];
      "org.kde.konsole.desktop"."NewWindow" = [ ];
      "org.kde.konsole.desktop"."_launch" = ["Meta+T" "Ctrl+Alt+T"];
      ...
      "org.kde.spectacle.desktop"."RectangularRegionScreenShot" = ["Meta+Shift+Print" "Ctrl+Shift+L"];
      ...
      "org_kde_powerdevil"."Decrease Screen Brightness" = ["Ctrl+PgDown" "Monitor Brightness Down"];
      "org_kde_powerdevil"."Hibernate" = "Hibernate";
      "org_kde_powerdevil"."Increase Keyboard Brightness" = "Keyboard Brightness Up";
      "org_kde_powerdevil"."Increase Screen Brightness" = ["Ctrl+PgUp" "Monitor Brightness Up"];
      ...
      "plasmashell"."show dashboard" = ["Ctrl+F12" "Meta+M"];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."536294ee-fb25-485f-aecd-ecde094ef620" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "536294ee-fb25-485f-aecd-ecde094ef620";
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1=1.25;HDMI-1=1.25;DP-1=1.25;HDMI-2=1.25;DP-2=1.25;HDMI-3=1.25;";
      "kdeglobals"."Shortcuts"."Activate Next Tab" = "Ctrl+]";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{b8214745-2daa-4a57-88a2-9af4e62ad3fc}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{10c44fa1-3583-47b9-9b00-5f704390cffd}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{893039a7-c7d9-4cd8-9403-b36c65402819}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{07afaaa0-cce3-4110-a942-6a9f8a5f3499}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{4c56abd0-0c59-4745-97cb-50aec7b36878}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{f858c054-6df2-4316-bf31-fec4bdd79b74}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{34e2eb9b-c8b2-490e-b52e-407063f65722}";
      ...
      "kwinrc"."Desktops"."Id_1" = "d5156c31-5d09-4cb0-897d-780bb1acb825";
      "kwinrc"."Desktops"."Id_2" = "b3a95a1c-51fb-4115-aebd-31e1dc1114bf";
      "kwinrc"."Desktops"."Id_3" = "ae100c51-b20e-4a7b-954d-5e7b61cf0533";
      "kwinrc"."Desktops"."Id_4" = "20a642dc-68cb-4873-8aa3-81ae950fde93";
      "kwinrc"."Desktops"."Id_5" = "a81d92a9-a133-470d-90f0-f379dabeeefd";
      ...
      "kwinrc"."Tiling.248e29a1-2997-550c-94c1-6343b0b87262"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
